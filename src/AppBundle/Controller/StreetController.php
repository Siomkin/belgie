...
class StreetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Street')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Street:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Street')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Street:edit.html.twig")
     */
