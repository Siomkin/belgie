...
use AppBundle\Entity\Destinations;
use AppBundle\Form\DestinationsType;
...
class DestinationsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Destinations')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Destinations:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Destinations')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Destinations:edit.html.twig")
     */
